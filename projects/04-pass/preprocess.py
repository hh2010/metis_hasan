"""
Script to preprocess our data for RNN-LSTM training in PyTorch
This is taken largely from Justin Johnson
...
parser.add_argument('--input_txt', default='data/pass.txt')
parser.add_argument('--output_h5', default='data/pass.h5')
parser.add_argument('--output_json', default='data/pass.json')
